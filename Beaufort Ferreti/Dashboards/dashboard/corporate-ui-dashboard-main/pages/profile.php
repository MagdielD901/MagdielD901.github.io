      ...
      <div class="container py-2">
        <nav aria-label="breadcrumb">
          <div class="d-flex align-items-center">
            <span class="px-3 font-weight-bold text-lg text-white me-4">Perfil</span>
          </div>
        </nav>
          ...
          <ul class="navbar-nav ms-md-auto  justify-content-end">
                    ...
                    <div class="d-flex py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">Nuevo mensaje</span> de Mag
                        </h6>
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
              <div class="avatar avatar-sm position-relative">
                <img src="../assets/img/perfil.jpg" alt="profile_image" class="w-100 border-radius-md">
              </div>
            </li>
            </a>
            </li>
        ...
        <div class="row">
          <div class="col-auto">
            <div class="avatar avatar-2xl rounded-circle position-relative mt-n7 border border-gray-100 border-4">
              <img src="../assets/img/perfil.jpg" alt="profile_image" class="w-100">
            </div>
          </div>
          <div class="col-auto my-auto">
            <div class="h-100">
              <h3 class="mb-0 font-weight-bold">
                <?php echo $user_data['name'].' '.$user_data['lastap']; ?>
              </h3>
              <p class="mb-0">
                MagdielD@mail.com
              </p>
          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3 text-sm-end">
            ...
            <a href="javascript:;" class="btn btn-sm btn-dark">Guardar</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-12 col-xl-4 mb-4">
          <div class="card border shadow-xs h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0 font-weight-semibold text-lg">Configuración</h6>
              <p class="text-sm mb-1">Aqui puedes colocar tus preferencias</p>
            </div>
            <div class="card-body p-3">
              <h6 class="text-dark font-weight-semibold mb-1">Cuenta</h6>
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    ...
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault1">...</label>
                  </div>
                </li>
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault2" checked>
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault2">...</label>
                  </div>
                </li>
              </ul>
              <h6 class="text-dark font-weight-semibold mt-2 mb-1">Permisos</h6>
              <ul class="list-group">
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault3">
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault3">...</label>
                  </div>
                </li>
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault4" checked>
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault4">...</label>
                  </div>
                </li>
                <li class="list-group-item border-0 px-0 pb-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault5">
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault5">...</label>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="card border shadow-xs h-100">
            <div class="card-header pb-0 p-3">
              <div class="row">
                <div class="col-md-8 col-9">
                  <h6 class="mb-0 font-weight-semibold text-lg">Información del perfil</h6>
                  <p class="text-sm mb-1">Edita tu información</p>
                </div>
            ...
            <div class="card-body p-3">
              <p class="text-sm mb-4">
                Hola soy Magdiel Dominguez
              </p>
              <ul class="list-group">
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pt-0 pb-1 text-sm"><span class="text-secondary">Nombre:</span> &nbsp; Jesus Magdiel</li>
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm"><span class="text-secondary">Apellidos:</span> &nbsp; Dominguez Baca</li>
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm"><span class="text-secondary">Telefono:</span> &nbsp; +1 123 1234 123</li>
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm"><span class="text-secondary">Función:</span> &nbsp; Administrador</li>
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm"><span class="text-secondary">Location:</span> &nbsp; Mex</li>
          ...
          <div class="card border shadow-xs h-100">
            <div class="card-header pb-0 p-3">
              <div class="row mb-sm-0 mb-2">
                <div class="col-md-8 col-9">
                  <h6 class="mb-0 font-weight-semibold text-lg">Chat</h6>
                  <p class="text-sm mb-0">Compañeros de trabajo</p>
                </div>
                <div class="col-md-4 col-3 text-end">
                  <button type="button" class="btn btn-white btn-icon px-2 py-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-1">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="mb-0 text-sm text-secondary">Hola! ...</p>
                  </div>
                  <span class="p-1 bg-success rounded-circle ms-auto me-3">
                    <span class="visually-hidden">En linea</span>
                  </span>
                </li>
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-1">
                  <div class="avatar avatar-sm rounded-circle me-2">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="mb-0 text-sm text-secondary">Hola, Noah!</p>
                  </div>
                  <span class="p-1 bg-success rounded-circle ms-auto me-3">
                    <span class="visually-hidden">En linea</span>
                  </span>
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-1">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="mb-0 text-sm text-secondary">Gracias!</p>
                  </div>
                  <span class="p-1 bg-success rounded-circle ms-auto me-3">
                    <span class="visually-hidden">En linea</span>
                  </span>
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-1">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="mb-0 text-sm text-secondary">No te preocupes! 🙏🏻</p>
                  </div>
                  <span class="p-1 bg-success rounded-circle ms-auto me-3">
                    <span class="visually-hidden">En linea</span>
                  </span>
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-1">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="mb-0 text-sm text-secondary">Por favor.</p>
                  </div>
                  <span class="p-1 bg-success rounded-circle ms-auto me-3">
                    <span class="visually-hidden">En linea</span>
                  </span>
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-1">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="mb-0 text-sm text-secondary">He terminado!</p>
                  </div>
                  <span class="p-1 bg-success rounded-circle ms-auto me-3">
                    <span class="visually-hidden">En linea</span>
                  </span>
        ...
        <div class="col-12">
          <div class="card shadow-xs border mb-4 pb-3">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0 font-weight-semibold text-lg">Pendientes generales</h6>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="col-xl-4 col-md-6 mb-xl-0 mb-4">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="blur shadow d-flex align-items-center w-100 border-radius-md border border-white mt-8 p-3">
                            <div class="w-50">
                              <p class="text-dark text-sm font-weight-bold mb-1">Magdiel Dominguez</p>
                              <p class="text-xs text-secondary mb-0">20 Nov 2024</p>
                            </div>
                            <p class="text-dark text-sm font-weight-bold ms-auto">Revisión</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <a href="javascript:;">
                    <h4 class="font-weight-semibold">
                      Revisar la ultima colección
                    </h4>
                  </a>
                  <p class="mb-4">
                    Revisar que este correctamente la ultima colección de ropa de invierno. 
                  </p>
                ...
                <div class="col-xl-4 col-md-6 mb-xl-0 mb-4">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="blur shadow d-flex align-items-center w-100 border-radius-md border border-white mt-8 p-3">
                            <div class="w-50">
                              <p class="text-dark text-sm font-weight-bold mb-1">Magdiel Dominguez</p>
                              <p class="text-xs text-secondary mb-0">1 Dic 2024</p>
                            </div>
                            <p class="text-dark text-sm font-weight-bold ms-auto">Reporte</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <p class="mb-4">
                    Generar reporte de las ventas realizadas el mes pasado.
                  </p>
                  <a href="javascript:;" class="text-dark font-weight-semibold icon-move-right mt-auto w-100 mb-5">
                    Ver pendiente
                    <i class="fas fa-arrow-right-long text-sm ms-1" aria-hidden="true"></i>
                  ...
                  <div class="card h-100 card-plain border border-dashed px-5">
                    <div class="card-body d-flex flex-column justify-content-center text-center">
                      <a href="javascript:;">
                        ...
                        <h5 class="text-dark text-lg"> Crear nuevo pendiente</h5>
                        <p class="text-sm text-secondary mb-0">Genera un nuevo pendiente aqui.</p>
                      </a>
                    </div>
                  </div>
                </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-xs text-muted text-lg-start">
                ...
                <a href="https://magdield901.github.io/" class="text-secondary" target="_blank">Beaufort Ferreti</a>.
              </div>
            </div>
            <div class="col-lg-6">
