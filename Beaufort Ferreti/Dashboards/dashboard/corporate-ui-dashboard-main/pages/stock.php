                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center ms-1">
                            ...
                            <p class="text-sm text-secondary mb-0">ID: <?php echo $fila ['id_producto'] ?></p>
                          </div>
                        </div>
                      </td>
                      <td> 
      ...
      <div class="modal fade modal-lg" id="stockModal" tabindex="-1" aria-labelledby="stockModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="../../../../Admin/php/add-stock.php" method="post" class="needs-validation" novalidate id="formS">
      
                 <div class="modal-body">
                 <div class="row">
                 <div class="col-6">
                <label for="">Nombre</label>
                <input name="nombre" required type="text" class="form-control" placeholder="Inserta el nombre del articulo">
               ...
               <input name="cantidad" required min="1" type="number" class="form-control" placeholder="Inserta la cantidad">
               <div class="valid-feedback"> Correcto</div>
                <div class="invalid-feedback">Cantidad no valida</div>
                   ...
                   <input name="estado" required type="text" class="form-control" placeholder="Ingresa el estatus">
                   <div class="valid-feedback"> Correcto</div>
               ...
               <input  name="date" required type="date" class="form-control" placeholder="Ingresa la fecha de actualización">
               <div class="valid-feedback"> Correcto</div>
    ...
    if(isset($_GET['status'])){
      if($_GET['status']==1){
        ...
        ?>
            ...
            icon: "error",
            title: "Oh no",
            text: "Algo esta mal, llena los datos correctamente. ¡Asegurate que el producto que intentas agregar al stock exista en la tabla de productos!",
            footer: '<a href="./productos.php">¿Agregar producto nuevo?</a>'
              });
</script>
        <?php
