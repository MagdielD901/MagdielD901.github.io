          ...
          <div class="container-fluid px-1">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="https://magdield901.github.io/" class="btn btn-sm mb-0 bg-gradient-dark">Regresar a la tienda</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Bienvenido de nuevo! Por favor ingresa tus datos.</p>
                </div>
                <div class="card-body">
                  <form action="../../../../Admin/php/login.php" method="post" role="form">
                 
                   
                    <label>Correo</label>
                    <div class="mb-3">
                      <input name="txtEmail" required type="email" class="form-control" placeholder="Ingresa tu correo" aria-label="Email" aria-describedby="email-addon">
                    </div>
                    <label>Contraseña</label>
                    <div class="mb-3">
                      <input name="txtPassword" required type="password" class="form-control" placeholder="Ingresa tu contraseña" aria-label="Password" aria-describedby="password-addon">
                    </div>
                    <div class="d-flex align-items-center">
                      <div class="form-check form-check-info text-left mb-0">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                        <label class="font-weight-normal text-dark mb-0" for="flexCheckDefault">
                          Recordar por 15 dias
                        </label>
                      </div>
                      <a href="javascript:;" class="text-xs font-weight-bold ms-auto">Olvide la contraseña</a>
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-xs mx-auto">
                    ...
                    <a href="./dashboard.html" class="text-dark font-weight-bold">Registrarse</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8" style="background-image:url('../assets/img/iniciar-sesion.jpg')">
                  <div class="blur mt-12 p-4 text-center border border-white border-radius-md position-absolute fixed-bottom m-4">
                    <h2 class="mt-3 text-dark font-weight-bold">Explora nuestras colecciones.</h2>
                    <h6 class="text-dark text-sm mt-5">Copyright © 2024 Beaufort Ferreti.</h6>
                  </div>
                </div>
              </div>
            </div>
