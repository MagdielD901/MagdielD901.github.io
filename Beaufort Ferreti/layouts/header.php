          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item ps-2 d-flex align-items-center">
              <a href="../pages/profile.html" class="nav-link text-body p-0">
                <img src="../assets/img/perfil.jpg" class="avatar avatar-sm" alt="avatar" />
              </a>
            </li>
            <!-- Imagen del perfil -->
     ...
     <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-2">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bold mb-0">Tablas</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
          ...
          <ul class="navbar-nav  justify-content-end">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">Nuevo reporte</span> de Google
                        </h6>
                        <p class="text-xs text-secondary mb-0 d-flex align-items-center ">
                          <i class="fa fa-clock opacity-6 me-1"></i>
                          1 dia
            ...
            <li class="nav-item ps-2 d-flex align-items-center">
              <a href="./profile.html" class="nav-link text-body p-0">
                <img src="../assets/img/perfil.jpg" class="avatar avatar-sm" alt="avatar" />
              </a>
            </li>
          </ul>
