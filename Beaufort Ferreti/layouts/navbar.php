...
<head>
    ...
    <link rel="stylesheet" href="./Dashboards/dashboard/corporate-ui-dashboard-main/assets/css/corporate-ui-dashboard.css">
</head>
<body>
        ...
        <div class="container-fluid px-1">
          ...
          <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto ms-xl-auto">
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center me-2 " aria-current="page" href="../principal/principal/index.html">
            ...
            <ul class="navbar-nav d-lg-block d-none">
              <li class="nav-item">
                <a href="https://magdield901.github.io/" class="btn btn-sm mb-0 bg-gradient-dark">Carrito</a>
              </li>
            </ul>
          </div>
        </div>
